# Terraform Config file (main.tf). This has provider block (AWS) and config for provisioning VPC resource.  
...
# Add provisioning of public subnets in the custom VPC
